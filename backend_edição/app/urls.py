...
from authentication.utils import PasswordResetRequestView, PasswordResetConfirmView
...
urlpatterns = [
    ...
    path('api/medconnect/password/reset/',         PasswordResetRequestView.as_view(),  name='password_reset'),
    path('api/medconnect/password/reset/confirm/', PasswordResetConfirmView.as_view(),  name='password_reset_confirm'),
