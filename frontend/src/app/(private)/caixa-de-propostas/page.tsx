...
export default function HistoricoPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      const listaPropostas = Array.isArray(propostasResult)
          ? propostasResult
          : (propostasResult as any)?.data
    ...
    <div className="max-w-5xl mx-auto py-10 px-4 md:px-0 font-sans">
      <div className="mb-8">
        ...
        <p className="text-zinc-500 mt-2">
          Acompanhe suas negociações e propostas enviadas .
        </p>
      </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-zinc-500 mt-2">
                      ...
                      {anuncio.cd_pessoa_compradora && (
                        <span className="flex items-center gap-1.5 bg-amber-50 px-2 py-1 rounded-md border border-amber-100">
